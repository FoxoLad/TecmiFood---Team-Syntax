//Pagina Inicio: promociones, accesos rápidos y los menús de cada cafetería.
  ...
  const loadMoreProducts = useCallback(
    (
      ...
      const { contentOffset, contentSize, layoutMeasurement } =
        event.nativeEvent;
      const reachedEnd =
        contentOffset.x + layoutMeasurement.width >= contentSize.width - 40;
    ...
    return [
      {
        ...
        data: allProducts.filter(
          (product) =>
            product.businessId === "BT" && isProductAvailable(product),
        ),
      },
      {
        businessId: "BS",
        ...
        data: allProducts.filter(
          (product) =>
            product.businessId === "BS" && isProductAvailable(product),
        ),
      },
    ];
  }, [allProducts, mode]);
      ...
      >
        <View style={styles.heroHeader}>
          <View>
            ...
            <Text style={styles.subtitle}>
              Tu antojo, a un toque de distancia.
            </Text>
          </View>
        ...
        <View style={styles.bannerContainer}>
          ...
          <View style={styles.bannerCaption}>
            ...
            <Text style={styles.bannerCaptionText}>
              Descubre algo delicioso hoy.
            </Text>
          </View>
            ...
            >
              ...
              <ScrollView
                ...
                onMomentumScrollEnd={(event) =>
                  loadMoreProducts(section, event)
                }
              ...
              >
                ...
                {(visibleProducts[section.businessId] ?? BATCH_SIZE) <
                section.data.length ? (
